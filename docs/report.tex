...
\begin{titlepage}
    \begin{center}
        \vspace*{1cm}
    {\fontsize{17}{16}\selectfont \textbf{Conceção e desenvolvimento de um sistema de quadro de expedição para operadores de transportes públicos baseado em tecnologias web}}
