...
\section{Solution Development}
    ...
    \subsection{Requirements}
        ...
        \vspace{1cm}
        \includegraphics[width=0.95\textwidth]{table_of_entries}
        ...
        \vspace{1cm}
        \includegraphics[width=0.95\textwidth]{table_of_exits}
        ...
        \vspace{1cm}
        \includegraphics[width=0.95\textwidth]{aparencia}
        \vspace{1cm}
        ...
        \vspace{1cm}
        \includegraphics[width=0.95\textwidth]{tabelas}
