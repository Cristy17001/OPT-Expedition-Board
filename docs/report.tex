...
\section{Solution Development}
    ...
    \subsection{Requirements}
        ...
        \begin{figure}[htbp]
            ...
            \caption{Table of entries for STCP (Example 1)}
        ...
        \begin{figure}[htbp]
            ...
            \caption{Table of entries for STCP (Example 2)}
            \label{fig:table_of_entries_stcp2}
        \end{figure}
        ...
        \begin{figure}[htbp]
            ...
            \caption{Table of exits for STCP (Example 1)}
        ...
        \begin{figure}[htbp]
            ...
            \includegraphics[width=0.95\textwidth]{table_of_entries_stcp2}
            \caption{Table of entries for STCP (Example 2)}
            \label{fig:table_of_entries_stcp2_}
        \end{figure}
